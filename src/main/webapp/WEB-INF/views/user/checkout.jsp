									...
									<div class="payment-icon">
										<ul>
											<li><img class="img-fluid"
												src="/user/images/payment-icon/1.png" alt=""></li>
											<li><img class="img-fluid"
												src="/user/images/payment-icon/2.png" alt=""></li>
											<li><img class="img-fluid"
												src="/user/images/payment-icon/3.png" alt=""></li>
											<li><img class="img-fluid"
												src="/user/images/payment-icon/5.png" alt=""></li>
											<li><img class="img-fluid"
												src="/user/images/payment-icon/7.png" alt=""></li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div class="col-sm-6 col-lg-6 mb-3">
					<div class="row">
								...
								<div class="rounded p-2 bg-light">
									<div class="media mb-2 border-bottom">
										<div class="media-body">
											<a href="${base}/shop-detail"> Lorem ipsum dolor sit amet</a>
						...
						<div class="col-12 d-flex shopping-box">
							<a href="${base}/checkout" class="ml-auto btn hvr-hover">Place
								Order</a>
						</div>
					</div>
				</div>
