		...
		<div class="container">
						...
						<table class="table">
							...
							<tbody>
								<c:forEach items="${cart.cartItems}" var="item" varStatus="loop">
									...
									<td class="thumbnail-img"><a href="${base}/shop-detail"> <img
											class="img-fluid" src="${base }/upload/${item.productAvatar}" alt="" />
									</a></td>
									<td class="name-pr"><a href="${base}/shop-detail"> ${item.productName } </a></td>
									<td class="price-pr">
										<p>${item.priceUnit }</p>
									</td>
									...
									<td class="remove-pr"><a href="${base}/shop-detail"> <i
			...
			<div class="row my-5">
				...
				<div class="col-12 d-flex shopping-box">
					<a href="${base}/checkout" class="ml-auto btn hvr-hover">Checkout</a>
				</div>
			</div>
