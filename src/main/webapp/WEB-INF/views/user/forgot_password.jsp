						...
						<%-- <div class="card-body">
							<form method="POST" action="/perform_login">
								...
								<div class="form-group">
									<label class="small mb-1" for="inputEmailAddress">User
										Name</label> <input class="form-control py-4" name="username"
								...
								<div
									...
									<button class="contact2-form-btn"
										style="background-color: #007bff; border: 2px #007bff; font-size: 17px;">Login</button>
								</div>
							</form>
						</div>
						...
						<form class="user" action="${base}/password/reset" method="POST">
							<div class="form-group">
								<input type="email" class="form-control form-control-user"
									id="emailResetPass" name="emailResetPass"
