							...
							<div
									...
									<div class="collapse show" id="sub-men1"
										...
										<div class="list-group">
											...
											<c:forEach items = "${categories }" var = "cate">
												<a href="${base}/shop-detail"
													class="list-group-item list-group-item-action active">${cate.name }
													<small class="text-muted">(50)</small>
												</a>
											</c:forEach>
										</div>
								...
								<div class="list-group-collapse sub-men">
									...
									<div class="collapse" id="sub-men2"
										...
										<div class="list-group">
											<a href="${base}/shop-detail"
												class="list-group-item list-group-item-action">Sports
												Shoes <small class="text-muted">(10)</small>
											</a> <a href="${base}/shop-detail"
												class="list-group-item list-group-item-action">Sneakers
												<small class="text-muted">(20)</small>
											</a> <a href="${base}/shop-detail"
												class="list-group-item list-group-item-action">Formal
								...
								<a href="${base}/shop-detail"
									class="list-group-item list-group-item-action"> Men <small
									class="text-muted">(150) </small></a> 
								<a href="${base}/shop-detail"
									class="list-group-item list-group-item-action">Accessories
									<small class="text-muted">(11)</small>
								</a> 
								<a href="${base}/shop-detail"
									class="list-group-item list-group-item-action">Bags <small
									class="text-muted">(22)</small>
								</a>
								 --%>
								<!--  -->
								<c:forEach items="${categories }" var="cate">
									<a href="${base}/shop/${cate.seo}"
									class="list-group-item list-group-item-action"> ${cate.name } <small
									class="text-muted">(150) </small></a> 
								</c:forEach>
							</div>
						</div>
											...
											<div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
												<div class="products-single fix">
													<div class="box-img-hover">
														...
														<img src="${base }/upload/${p.avatar}" class="img-fluid"
															alt="Image">
														<div class="mask-icon">
															<ul>
																<li><a href="${base}/shop-detail/${p.seo}"
																	data-toggle="tooltip" data-placement="right"
																	title="View"><i class="fas fa-eye"></i></a></li>
																<li><a href="#" data-toggle="tooltip"
																	data-placement="right" title="Compare"><i
																		class="fas fa-sync-alt"></i></a></li>
																<li><a href="${base}/wishlist"
																	data-toggle="tooltip" data-placement="right"
																	title="Add to Wishlist"><i class="far fa-heart"></i></a></li>
															</ul>
															<!-- Add cart -->
															<%-- <a clas="cart"><input type="number" value = "1" id="sl${p.id }" class="form-control mr-1" style="width: 60px;"></a>
															<a class="cart" onclick="Cart.addItemToCart(${p.id }, 'sl_${p.id }')">Add to Cart</a> --%>
															<div class="form-group d-flex justify-content-between" style="padding-top:10px;">
																<input type="number" value="1" id="sl_${p.id }"
																	class="form-control mr-1" style="width: 60px;">
																<button type="button" class="btn btn-sm" style="background:red; color:white"
																	onClick="Cart.addItemToCart(${p.id }, 'sl_${p.id }')">Add
																	to cart</button>
															</div>
														</div>
													</div>
													<div class="why-text">
														<h4>
															<a href="${base}/shop-detail/${p.seo}">${p.title }</a>
														</h4>
														<!-- shortdescription -->
														<h5>
										...
										<div class="row">
											...
											<div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
												<div class="why-text full-width">
													...
													<a class="btn hvr-hover" href="${base}/cart">Add to
														Cart</a>
												</div>
											</div>
										</div>
